...
public class FuelEconomyObdCommand extends ObdCommand {
  ...
  public void run(InputStream in, OutputStream out) throws IOException,
    ...
    fuelConsumptionCommand.setDeviceid(deviceid);
    fuelConsumptionCommand.setServerid(serverid);
    fuelConsumptionCommand.setSequenceid(sequenceid);
    fuelConsumptionCommand.run(in, out);

    // get metric speed
    final SpeedObdCommand speedCommand = new SpeedObdCommand();
    speedCommand.setDeviceid(deviceid);
    speedCommand.setServerid(serverid);
    speedCommand.setSequenceid(sequenceid);
